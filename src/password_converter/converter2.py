...
from utils import validate_entry, setup_logging
# from .exceptions import ConverterError, ValidationError
# from .utils import validate_entry, setup_logging
...
def main():
    ...
    parser.add_argument("input", help="Path to input file or raw text")
    ...
    if Path(args.input).is_file():
        ...
        try:
            ...
            logger.info(f"Successfully converted {len(data)} entries from text")
        except Exception as e:
